...
<br>enhancement loan?</h2>
                                        <div class="welcome-button" data-animation-in="fadeInDown" data-animation-out="animate-out fadeOutDown">
                                            <a href="apply.php" class="btn btn-default button-primary">Apply Loan</a>
                                            <a href="contact.php" class="button-secondary btn btn-default">Contact Us</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<br>your interest rate</h2>
                                        <div class="welcome-button" data-animation-in="fadeInLeft" data-animation-out="animate-out fadeOutLeft">
                                            <a href="apply.php" class="btn btn-default button-primary"><span></span>  Apply Now </a>
                                            <a href="contact.php" class="button-secondary btn btn-default"><span></span>  Contact Now </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="single-why-choose">
                        ...
                        <div class="choose-title">
                            <h4><img src="asset/img/icon-2.png" alt="">No Hidden Fees</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="single-why-choose">
                        ...
                        <div class="choose-title">
                            <h4><img src="asset/img/icon-3.png" alt="">Less Documents</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="single-why-choose">
                        ...
                        <div class="choose-title">
                            <h4><img src="asset/img/icon-4.png" alt="">Specialist Team</h4>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="display-table">
                                    <div class="display-cell">
                                        <div class="team-hover-content">
                                            ...
                                            <p>Stuart Binny has Loan Consultant to solve all loan query in Golden thataka secured loan team.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="display-table">
                                    <div class="display-cell">
                                        <div class="team-hover-content">
                                            ...
                                            <p>Joe Elsworth has Head of Operations to solve customer query in Golden thataka secured loan team.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="display-table">
                                    <div class="display-cell">
                                        <div class="team-hover-content">
                                            ...
                                            <p>Thomas Finch has Customer Relations to solve customer query in Golden thataka secured loan team.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="testimonial-slider owl-carousel">
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-content">
                            ...
                            <h5>Self Employee</h5>
                            <p>“Golden thataka secured loan provide me a best rate compare to rest of bank i visted on all localbank.”</p>
                        </div>
                    </div>
                    <div class="single-testimonial">
                        <div class="testimonial-img">
                        ...
                        <div class="testimonial-content">
                            <h4>Nia Jax</h4>
                            <h5>IT Manager</h5>
                            <p>“ Golden thataka secured loan dеlіvеrеd еxасtlу whаt thеу offered. Nоt only dіd thеу оffеr uѕ a better rate.”</p>
                        </div>
                    </div>
                    <div class="single-testimonial">
                        <div class="testimonial-img">
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-content">
                            ...
                            <p>“ Dесlіnеd bу my local bаnk for a personal lоаn, I аm vеrу grаtеful tо Golden thataka secured loan!.”</p>
                        </div>
                    </div>
                    <div class="single-testimonial">
                        <div class="testimonial-img">
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="map-content">
                        ...
                        <a href="apply.php" class="button btn btn-primary btn-sm"><i class="fa fa-reply-all"></i> APPLY NOW </a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-article-list">
                        <div class="article-list-img">
                            <a href="#"><img src="asset/img/articale-sm.jpg" alt=""></a>
                        </div>
                    ...
                    <div class="single-article-list">
                        <div class="article-list-img">
                            <a href="#"><img src="asset/img/articale-sm-2.jpg" alt=""></a>
                        </div>
                        <div class="article-list-content">
